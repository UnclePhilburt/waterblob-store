...
const assemblySteps: string[] = [
  ...
  'Inflate using a leaf blower or a shop vac with a two-way switch. A 6.5 horsepower shop vac is recommended \u2014 that\u2019s what we use.',
        ...
        <div className={styles.container}>
          ...
          {renderSection(
            ...
            <>
              ...
              <ul className={styles.list}>
                <li>Leaf blower</li>
                <li>Shop vac with a two-way switch (6.5 horsepower recommended)</li>
              </ul>
            </>
          )}
